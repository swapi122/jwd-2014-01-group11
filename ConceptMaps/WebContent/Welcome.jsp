...
<!-- end main -->
	...
	<script src="resoures/assets/js/jquery-ui-1.10.4.custom.min.js" type="text/javascript"></script>

	<script src="resoures/assets/js/gsdk-checkbox.js"></script>
	<script src="resoures/assets/js/gsdk-radio.js"></script>
	<script src="resoures/assets/js/gsdk-switch.js"></script>
	<script src="resoures/assets/js/get-shit-done.js"></script>
	
    <script src="resoures/assets/js/custom.js"></script>
